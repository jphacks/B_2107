<template>
  <v-app id="inspire">
    ...
    <v-main>
          ...
          <v-card-title>
            <v-dialog v-model="dialog" persistent max-width="600px">
              ...
              <v-card>
                ...
                <v-card-actions>
                  <v-spacer></v-spacer>
                  <v-btn color="blue darken-1" text @click="dialog_f">
                    Close
                  </v-btn>
                  <v-btn color="blue darken-1" text @click="dialog_t">
                    Save
                  </v-btn>
                </v-card-actions>
              </v-card>
              ...
              <v-card-actions>
                <v-list-item class="grow">
                  <v-list-item-avatar color="grey darken-3">
                    <v-img class="elevation-6" :src="data.user_image"></v-img>
                  </v-list-item-avatar>
      ...
      <v-col>
        <v-btn class="vote-btn" x-large outlined color="#00AA6E" @click="result"
          >投票結果を見る</v-btn
        >
      </v-col>
    </v-main>
